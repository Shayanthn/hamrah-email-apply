...
![Version](https://img.shields.io/badge/version-1.0.0-blue.svg?style=flat-square) ![License](https://img.shields.io/badge/license-MIT-green.svg?style=flat-square) ![Platform](https://img.shields.io/badge/platform-Windows%20%7C%20Mac%20%7C%20Linux-lightgrey.svg?style=flat-square) ![Persian](https://img.shields.io/badge/lang-Persian-red.svg?style=flat-square)
...
وقتی برای اپلای دکتری اقدام می‌کردم، با مشکلات زیر روبرو شدم:

- ✉️ بیش از ۵۰ ایمیل به اساتید و گم کردن پیگیری‌ها
- ⏰ فراموشی ددلاین‌ها و سردرگمی
- 📊 نداشتن آمار و پیشرفت
- 📝 قاطی شدن SOPها و مدارک

برای همین تصمیم گرفتم **همراه ایمیل اپلای** را بسازم تا همه این مشکلات را حل کنم!
...
- 👤 مدیریت کامل پروفایل و سوابق تحصیلی
- 👨‍🏫 دیتابیس اساتید با جستجو و دسته‌بندی
- 📧 پیگیری وضعیت ایمیل‌ها (ارسال، پاسخ، رد)
- 🗂️ مدیریت درخواست‌ها و ددلاین‌ها
- 📊 داشبورد آمار و موفقیت
- 🌓 تم روشن و تیره
- 🇮🇷 کاملاً فارسی و راست‌چین

### نسخه پریمیوم (هوش مصنوعی)

- 🤖 نویسنده ایمیل و SOP با AI
- 🎯 پیشنهاد استاد هوشمند
- 📈 تحلیل احتمال قبولی و رتبه‌بندی
- 📝 ویرایش حرفه‌ای متون
- 💬 مشاور شخصی و راهنمای مصاحبه
- 🛂 راهنمای ویزا و اپلای
...
۱. ساخت پروفایل و وارد کردن اطلاعات
۲. اضافه کردن اساتید و ثبت ایمیل‌ها
۳. مدیریت درخواست‌ها و ددلاین‌ها
۴. مشاهده آمار و پیشرفت

---

## 💎 پلن‌های پریمیوم

| پلن | قیمت | امکانات کلیدی |
|---|---|---|
| 🥈 نقره‌ای | ۱۹۸,۰۰۰ تومان | نویسنده ایمیل با AI، پیشنهاد استاد، پشتیبانی ایمیلی |
| 🥇 طلایی | ۳۹۸,۰۰۰ تومان | همه امکانات نقره‌ای + نویسنده SOP، تحلیل رزومه، مشاوره آنلاین |
| 💎 الماسی | ۵۹۸,۰۰۰ تومان | همه امکانات طلایی + مشاور AI اختصاصی، پشتیبانی VIP |
...
- ذخیره محلی داده‌ها (LocalStorage)
...
این پروژه متن‌باز است و از مشارکت شما استقبال می‌شود!

۱. Fork کنید
۲. Branch جدید بسازید
۳. Commit و Pull Request ارسال کنید
...
- [بحث و گفتگو](https://github.com/Shayanthn/hamrah-email-apply/discussions)
...
- اگر این پروژه به شما کمک کرد، لطفاً ستاره بدهید ⭐
